...
const Input = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    })}</select>` : `${type == "text" ? `<input type="text" name="field" class="svelte-1jwyxyw"${add_attribute("value", value, 0)}>` : `${type == "number" ? `<input type="number" name="field" class="svelte-1jwyxyw"${add_attribute("value", value, 0)}>` : `${type == "iban" ? `<input type="text" inputmode="numeric" pattern="${"[0-9\\s]" + escape(19, true)}" autocomplete="cc-number" maxlength="19" placeholder="xxxx xxxx xxxx xxxx" name="field" class="svelte-1jwyxyw"${add_attribute("value", value, 0)}>` : `${type == "toggle" ? `${validate_component(Toggle, "Toggle").$$render(
      $$result,
...
const css$5 = {
  code: "input.svelte-nc7eik::-webkit-outer-spin-button,input.svelte-nc7eik::-webkit-inner-spin-button{-webkit-appearance:none;margin:0}input[type='number'].svelte-nc7eik{-moz-appearance:textfield}input.svelte-nc7eik:first-child{border-radius:6px 0px 0px 6px;border-width:2px 2px 2px 2px;width:200%}input.last.svelte-nc7eik{margin:0;border-radius:0 6px 6px 0;border-width:2px 2px 2px 0px;margin-right:0.5rem}input.svelte-nc7eik{width:100%;text-align:end;box-sizing:border-box;border:2px solid black;border-width:2px 2px 2px 0px;outline:none;height:2rem;padding:0.5rem;font-size:1rem;transition:0.1s ease-in-out;box-shadow:0px 0px}select.svelte-nc7eik{width:100%;text-align:end;box-sizing:border-box;border:2px solid black;border-width:2px 2px 2px 0px;outline:none;height:2rem;padding:0rem 0.5rem 0rem 0.5rem;font-size:1rem;transition:0.1s ease-in-out;box-shadow:0px 0px;background-color:white;cursor:pointer}option.svelte-nc7eik{box-sizing:border-box;border:2px solid black;background-color:rgb(235, 235, 235)}input.svelte-nc7eik:focus{transform:translateY(-5px);box-shadow:0px 5px;background-color:rgb(235, 235, 235);border-width:2px 2px 2px 2px}div.svelte-nc7eik{display:flex;flex-direction:row;justify-content:space-between;align-items:center;padding-top:1rem}.svelte-nc7eik::-moz-selection{color:white;background:black}.svelte-nc7eik::selection{color:white;background:black}input.sub.svelte-nc7eik{border-width:0 0 2px 0;width:70%;text-align:left}",
  map: `{"version":3,"file":"rowInput.svelte","sources":["rowInput.svelte"],"sourcesContent":["<script>\\n\\timport { createEventDispatcher } from 'svelte';\\n\\texport let entry;\\n\\texport let labels;\\n\\timport Button from './Button.svelte';\\n\\timport Input from './Input.svelte';\\n\\n\\tconst dispatch = createEventDispatcher();\\n\\n\\tfunction addSub() {\\n\\t\\tentry.sub.push('');\\n\\t\\tentry.sub = entry.sub;\\n\\t\\tconsole.log(entry);\\n\\t}\\n\\tfunction remove(event) {\\n\\t\\tevent.preventDefault();\\n\\t\\tconsole.log('delete this');\\n\\t\\tdispatch('remove', { target: entry });\\n\\t}\\n\\tfunction removeSub(event) {\\n\\t\\tevent.preventDefault();\\n\\t\\tentry.sub.splice(entry.sub.indexOf(event.target.value), 1);\\n\\t\\tentry.sub = entry.sub;\\n\\t}\\n<\/script>\\n\\n<div on:contextmenu={remove}>\\n\\t<input type=\\"text\\" bind:value={entry.title} />\\n\\t<select bind:value={entry.unit}>\\n\\t\\t<option value=\\"0\\">{labels.units[0]}</option>\\n\\t\\t<option value=\\"1\\">{labels.units[1]}</option>\\n\\t\\t<option value=\\"2\\">{labels.units[2]}</option>\\n\\t\\t<option value=\\"3\\">-</option>\\n\\t</select>\\n\\t<input type=\\"number\\" bind:value={entry.amount} />\\n\\t<input class=\\"last\\" type=\\"number\\" bind:value={entry.price} />\\n\\t<Button label=\\"✱\\" on:click={addSub}></Button>\\n</div>\\n{#each entry.sub as sub}\\n\\t<input bind:value={sub} on:contextmenu={removeSub} class=\\"sub\\" type=\\"text\\" />\\n{/each}\\n\\n<style>\\n\\tinput::-webkit-outer-spin-button,\\n\\tinput::-webkit-inner-spin-button {\\n\\t\\t-webkit-appearance: none;\\n\\t\\tmargin: 0;\\n\\t}\\n\\t/* Firefox */\\n\\tinput[type='number'] {\\n\\t\\t-moz-appearance: textfield;\\n\\t}\\n\\tinput:first-child {\\n\\t\\tborder-radius: 6px 0px 0px 6px;\\n\\t\\tborder-width: 2px 2px 2px 2px;\\n\\t\\twidth: 200%;\\n\\t}\\n\\tinput.last {\\n\\t\\tmargin: 0;\\n\\t\\tborder-radius: 0 6px 6px 0;\\n\\t\\tborder-width: 2px 2px 2px 0px;\\n\\t\\tmargin-right: 0.5rem;\\n\\t}\\n\\tinput {\\n\\t\\twidth: 100%;\\n\\t\\ttext-align: end;\\n\\t\\tbox-sizing: border-box;\\n\\t\\tborder: 2px solid black;\\n\\t\\tborder-width: 2px 2px 2px 0px;\\n\\t\\toutline: none;\\n\\t\\theight: 2rem;\\n\\t\\tpadding: 0.5rem;\\n\\t\\tfont-size: 1rem;\\n\\t\\ttransition: 0.1s ease-in-out;\\n\\t\\tbox-shadow: 0px 0px;\\n\\t}\\n\\tselect {\\n\\t\\twidth: 100%;\\n\\t\\ttext-align: end;\\n\\t\\tbox-sizing: border-box;\\n\\t\\tborder: 2px solid black;\\n\\t\\tborder-width: 2px 2px 2px 0px;\\n\\n\\t\\toutline: none;\\n\\t\\theight: 2rem;\\n\\t\\tpadding: 0rem 0.5rem 0rem 0.5rem;\\n\\t\\tfont-size: 1rem;\\n\\t\\ttransition: 0.1s ease-in-out;\\n\\t\\tbox-shadow: 0px 0px;\\n\\t\\tbackground-color: white;\\n\\t\\tcursor: pointer;\\n\\t}\\n\\n\\toption {\\n\\t\\tbox-sizing: border-box;\\n\\t\\tborder: 2px solid black;\\n\\t\\tbackground-color: rgb(235, 235, 235);\\n\\t}\\n\\n\\tinput:focus {\\n\\t\\ttransform: translateY(-5px);\\n\\t\\tbox-shadow: 0px 5px;\\n\\t\\tbackground-color: rgb(235, 235, 235);\\n\\t\\tborder-width: 2px 2px 2px 2px;\\n\\t}\\n\\tdiv {\\n\\t\\tdisplay: flex;\\n\\t\\tflex-direction: row;\\n\\t\\tjustify-content: space-between;\\n\\t\\talign-items: center;\\n\\t\\tpadding-top: 1rem;\\n\\t}\\n\\t::-moz-selection {\\n\\t\\t/* Code for Firefox */\\n\\t\\tcolor: white;\\n\\t\\tbackground: black;\\n\\t}\\n\\n\\t::selection {\\n\\t\\tcolor: white;\\n\\t\\tbackground: black;\\n\\t}\\n\\tinput.sub {\\n\\t\\tborder-width: 0 0 2px 0;\\n\\t\\twidth: 70%;\\n\\t\\ttext-align: left;\\n\\t}\\n</style>\\n"],"names":[],"mappings":"AA2CC,mBAAK,2BAA2B,CAChC,mBAAK,2BAA4B,CAChC,kBAAkB,CAAE,IAAI,CACxB,MAAM,CAAE,CACT,CAEA,KAAK,CAAC,IAAI,CAAC,QAAQ,eAAE,CACpB,eAAe,CAAE,SAClB,CACA,mBAAK,YAAa,CACjB,aAAa,CAAE,GAAG,CAAC,GAAG,CAAC,GAAG,CAAC,GAAG,CAC9B,YAAY,CAAE,GAAG,CAAC,GAAG,CAAC,GAAG,CAAC,GAAG,CAC7B,KAAK,CAAE,IACR,CACA,KAAK,mBAAM,CACV,MAAM,CAAE,CAAC,CACT,aAAa,CAAE,CAAC,CAAC,GAAG,CAAC,GAAG,CAAC,CAAC,CAC1B,YAAY,CAAE,GAAG,CAAC,GAAG,CAAC,GAAG,CAAC,GAAG,CAC7B,YAAY,CAAE,MACf,CACA,mBAAM,CACL,KAAK,CAAE,IAAI,CACX,UAAU,CAAE,GAAG,CACf,UAAU,CAAE,UAAU,CACtB,MAAM,CAAE,GAAG,CAAC,KAAK,CAAC,KAAK,CACvB,YAAY,CAAE,GAAG,CAAC,GAAG,CAAC,GAAG,CAAC,GAAG,CAC7B,OAAO,CAAE,IAAI,CACb,MAAM,CAAE,IAAI,CACZ,OAAO,CAAE,MAAM,CACf,SAAS,CAAE,IAAI,CACf,UAAU,CAAE,IAAI,CAAC,WAAW,CAC5B,UAAU,CAAE,GAAG,CAAC,GACjB,CACA,oBAAO,CACN,KAAK,CAAE,IAAI,CACX,UAAU,CAAE,GAAG,CACf,UAAU,CAAE,UAAU,CACtB,MAAM,CAAE,GAAG,CAAC,KAAK,CAAC,KAAK,CACvB,YAAY,CAAE,GAAG,CAAC,GAAG,CAAC,GAAG,CAAC,GAAG,CAE7B,OAAO,CAAE,IAAI,CACb,MAAM,CAAE,IAAI,CACZ,OAAO,CAAE,IAAI,CAAC,MAAM,CAAC,IAAI,CAAC,MAAM,CAChC,SAAS,CAAE,IAAI,CACf,UAAU,CAAE,IAAI,CAAC,WAAW,CAC5B,UAAU,CAAE,GAAG,CAAC,GAAG,CACnB,gBAAgB,CAAE,KAAK,CACvB,MAAM,CAAE,OACT,CAEA,oBAAO,CACN,UAAU,CAAE,UAAU,CACtB,MAAM,CAAE,GAAG,CAAC,KAAK,CAAC,KAAK,CACvB,gBAAgB,CAAE,IAAI,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,GAAG,CACpC,CAEA,mBAAK,MAAO,CACX,SAAS,CAAE,WAAW,IAAI,CAAC,CAC3B,UAAU,CAAE,GAAG,CAAC,GAAG,CACnB,gBAAgB,CAAE,IAAI,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,GAAG,CAAC,CACpC,YAAY,CAAE,GAAG,CAAC,GAAG,CAAC,GAAG,CAAC,GAC3B,CACA,iBAAI,CACH,OAAO,CAAE,IAAI,CACb,cAAc,CAAE,GAAG,CACnB,eAAe,CAAE,aAAa,CAC9B,WAAW,CAAE,MAAM,CACnB,WAAW,CAAE,IACd,eACA,gBAAiB,CAEhB,KAAK,CAAE,KAAK,CACZ,UAAU,CAAE,KACb,eAEA,WAAY,CACX,KAAK,CAAE,KAAK,CACZ,UAAU,CAAE,KACb,CACA,KAAK,kBAAK,CACT,YAAY,CAAE,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,CAAC,CACvB,KAAK,CAAE,GAAG,CACV,UAAU,CAAE,IACb"}`
};
const RowInput = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="svelte-nc7eik"><input type="text" class="svelte-nc7eik"${add_attribute("value", entry.title, 0)}> <select class="svelte-nc7eik"><option value="0" class="svelte-nc7eik">${escape(labels.units[0])}</option><option value="1" class="svelte-nc7eik">${escape(labels.units[1])}</option><option value="2" class="svelte-nc7eik">${escape(labels.units[2])}</option><option value="3" class="svelte-nc7eik" data-svelte-h="svelte-vrf9wm">-</option></select> <input type="number" class="svelte-nc7eik"${add_attribute("value", entry.amount, 0)}> <input class="last svelte-nc7eik" type="number"${add_attribute("value", entry.price, 0)}> ${validate_component(Button, "Button").$$render($$result, { label: "✱" }, {}, {})}</div> ${each(entry.sub, (sub) => {
    return `<input class="sub svelte-nc7eik" type="text"${add_attribute("value", sub, 0)}>`;
  })}`;
});
const css$4 = {
...
EPD`;
    ...
    $$rendered = `<div id="container" class="svelte-i2nfs4"><div id="previewArea" class="svelte-i2nfs4"><div id="invoice" class="svelte-i2nfs4"><div id="page" style="${"--page-width:" + escape(pw, true)}" class="svelte-i2nfs4"><div id="header" class="svelte-i2nfs4"><div id="sender" class="svelte-i2nfs4">${store.logo ? `<div id="logo" class="svelte-i2nfs4">${validate_component(Logo, "Logo").$$render($$result, {}, {}, {})}</div> <p class="svelte-i2nfs4">${escape(store.sender.name)}</p>` : `<h3 class="svelte-i2nfs4">${escape(store.sender.name)}</h3>`} <p class="svelte-i2nfs4">${escape(store.sender.address.street)} ${escape(store.sender.address.number)}</p> <p class="svelte-i2nfs4">${escape(store.sender.address.code)} ${escape(store.sender.address.region)}</p> <p class="svelte-i2nfs4">${escape(getCountryData(store.sender.address.country).name)} ${escape(store.sender.address.country)}</p> <p class="svelte-i2nfs4">${escape(store.sender.address.mail)}</p> <p class="svelte-i2nfs4">${escape(store.sender.address.website)}</p></div> <div id="receiver" class="svelte-i2nfs4"><h3 class="svelte-i2nfs4">${escape(labels.invoice)}</h3> <p class="svelte-i2nfs4">${escape(invoiceID)}</p> <p class="svelte-i2nfs4">${escape(formatDate)}</p> <h3 class="svelte-i2nfs4">${escape(store.receiver.name)}</h3> <p class="svelte-i2nfs4">${escape(store.receiver.address.street)} ${escape(store.receiver.address.number)}</p> <p class="svelte-i2nfs4">${escape(store.receiver.address.code)} ${escape(store.receiver.address.region)}</p> <p class="svelte-i2nfs4">${escape(getCountryData(store.receiver.address.country).name)} ${escape(store.receiver.address.country)}</p></div></div> <div id="body" class="svelte-i2nfs4"><div class="svelte-i2nfs4"><div id="table" class="svelte-i2nfs4">${validate_component(Table, "Table").$$render(
      $$result,
      {
        currencyToggle: store.currencyToggle,
        exemptToggle: store.exemptToggle,
      ...
      {}
    )}</div></div></div> <div id="footer" class="svelte-i2nfs4"><div id="info" class="svelte-i2nfs4"><h3 class="svelte-i2nfs4">${escape(labels.account.toUpperCase())}</h3> <p class="svelte-i2nfs4">${escape(store.sender.name)}</p> <p class="svelte-i2nfs4">${escape(store.sender.address.street)} ${escape(store.sender.address.number)}</p> <p class="svelte-i2nfs4">${escape(store.sender.address.code)} ${escape(store.sender.address.region)}</p> <p class="svelte-i2nfs4">${escape(getCountryData(store.receiver.address.country).name)}</p> <h3 class="svelte-i2nfs4" data-svelte-h="svelte-xdjhkk">IBAN</h3> <p class="svelte-i2nfs4">${escape(store.sender.iban)}</p> <div class="split svelte-i2nfs4"><div class="svelte-i2nfs4"><h3 class="svelte-i2nfs4">${escape(labels.currency.toUpperCase())}</h3> <p class="svelte-i2nfs4">${escape(currency)}</p></div> <div class="svelte-i2nfs4"><h3 class="svelte-i2nfs4">${escape(labels.amount.toUpperCase())}</h3> <p class="svelte-i2nfs4">${escape(totals.ttc)}</p></div></div></div> <div id="qr" class="svelte-i2nfs4"><img${add_attribute("src", qr, 0)} alt="" class="svelte-i2nfs4"></div> <div id="contact" class="svelte-i2nfs4"><h3 class="svelte-i2nfs4">${escape(labels.tva)} N°</h3> <p class="svelte-i2nfs4">${escape(store.vatno)}</p> <h3 class="svelte-i2nfs4" data-svelte-h="svelte-14mctv5">REFERENCE</h3> <p class="svelte-i2nfs4">${escape(invoiceID)}</p> <h3 class="svelte-i2nfs4" data-svelte-h="svelte-qdpbsu">CONTACT</h3> <p class="svelte-i2nfs4">${escape(store.sender.address.mail)}</p> <div class="split svelte-i2nfs4"><div class="svelte-i2nfs4"><h3 class="svelte-i2nfs4">${escape(labels.currency.toUpperCase())}</h3> <p class="svelte-i2nfs4">${escape(currency)}</p></div> <div class="svelte-i2nfs4"><h3 class="svelte-i2nfs4">${escape(labels.amount.toUpperCase())}</h3> <p class="svelte-i2nfs4">${escape(totals.ttc)}</p></div></div></div></div></div></div></div> <div id="formArea" class="svelte-i2nfs4"><div id="form" class="svelte-i2nfs4">${validate_component(Section, "Section").$$render($$result, { title: "Sender" }, {}, {
      default: () => {
      ...
      default: () => {
        return `<div id="controls" class="svelte-i2nfs4"><div class="svelte-i2nfs4">${validate_component(Input, "Input").$$render(
          $$result,
          {
            type: "toggle",
            label: "Language",
    ...
    })} <div id="save" class="svelte-i2nfs4">${validate_component(Button, "Button").$$render(
      $$result,
      {
        col: "green",
        type: "big",
      ...
      {},
      {}
    )}</div></div></div> ${validate_component(SavePicker, "SavePicker").$$render(
      $$result,
